# awesome-weex with stars

[Weex](https://github.com/apache/incubator-weex/) ⚠️ Archived: A framework for building Mobile cross-platform UI.
...
* [h5weex相关文章](https://github.com/h5weex/h5weex-books) ⭐ 12 | 🐛 0 | 🌐 HTML | 📅 2016-09-25

* [h5weex-books](https://github.com/h5weex/h5weex-books) ⭐ 12 | 🐛 0 | 🌐 HTML | 📅 2016-09-25 h5weex相关文章

* [weex note - sunqichao](https://github.com/sunqichao/sqcweex.github.com) ⭐ 1 | 🐛 0 | 📅 2017-01-12
...
* [weex中使用数据流工具Vuex实践](https://github.com/weexteam/article/issues/62) ⚠️ Archived

* [浅析weex之vdom渲染](https://github.com/weexteam/article/issues/51) ⚠️ Archived

* [Weex调试神器——Weex Devtools使用手册 ](https://github.com/weexteam/article/issues/50) ⚠️ Archived

* [Weex meets Vue，记一次 Weex 前端团队的讨论](https://github.com/weexteam/article/issues/77) ⚠️ Archived

* [【适配】记一次 Weex 的 iPhone X 适配 ](https://github.com/zwwill/blog/issues/15) ⭐ 465 | 🐛 27 | 📅 2021-05-21
...
* [incubator-weex-loader](https://github.com/apache/incubator-weex-loader) ⚠️ Archived [![GitHub stars](https://img.shields.io/github/stars/apache/incubator-weex-loader.svg)]() A webpack loader for Weex.

* [weex-language-support](https://github.com/misakuo/weex-language-support) ⭐ 43 | 🐛 4 | 🌐 Java | 📅 2020-03-30 [![GitHub stars](https://img.shields.io/github/stars/misakuo/weex-language-support.svg)]() IntelliJ plugin for weex ,关于使用可以查看此文，[Intellij Weex 插件使用说明](http://blog.qianlicao.cn/technology/2016/07/07/intellij-plugin-instruction/)

* [easywebpack-weex](https://github.com/easy-team/easywebpack-weex) ⭐ 7 | 🐛 1 | 🌐 JavaScript | 📅 2019-03-29 [![GitHub stars](https://img.shields.io/github/stars/easy-team/easywebpack-weex.svg)]() Weex + Vue + Webpack的build解决方案
...
* [mpvue-weex](https://github.com/zhongku/mpvue-weex) ⭐ 863 | 🐛 0 | 🌐 Vue | 📅 2019-12-20 [![GitHub stars](https://img.shields.io/github/stars/zhongku/mpvue-weex.svg)]() 一套 Vue 代码，五端可用(H5、小程序、PC、苹果App、安卓App）

* [GSYGithubAppWeex](https://github.com/CarGuo/GSYGithubAppWeex) ⭐ 748 | 🐛 17 | 🌐 JavaScript | 📅 2026-08-11 [![GitHub stars](https://img.shields.io/github/stars/CarGuo/GSYGithubAppWeex.svg)]() 拥有Flutter、Weex、ReactNative三个版本。
...
* [weex-todo-list](https://github.com/tralves/weex-todo-list) ⭐ 154 | 🐛 4 | 🌐 Java | 📅 2017-03-24 [![GitHub stars](https://img.shields.io/github/stars/tralves/weex-todo-list.svg)]()

* [amap-running-app](https://github.com/weex-plugins/amap-running-app) ⚠️ Archived [![GitHub stars](https://img.shields.io/github/stars/weex-plugins/amap-running-app.svg)]() 一款简易的跑步App
...
* [WeexZhihuDaily](https://github.com/nuptboyzhb/WeexZhihuDaily) ⭐ 71 | 🐛 2 | 🌐 JavaScript | 📅 2017-01-16 [![GitHub stars](https://img.shields.io/github/stars/nuptboyzhb/WeexZhihuDaily.svg)]() weex版知乎日报

* [incubator-weex-playground](https://github.com/apache/incubator-weex-playground) ⚠️ Archived [![GitHub stars](https://img.shields.io/github/stars/apache/incubator-weex-playground.svg)]() Playground for Apache Weex, demo purpose only
...
* [weex-vue-examples](https://github.com/Hanks10100/weex-vue-examples) ⭐ 212 | 🐛 16 | 🌐 JavaScript | 📅 2026-07-28 [![GitHub stars](https://img.shields.io/github/stars/Hanks10100/weex-vue-examples.svg)]()  Examples of using Weex and Vue.js
...
* [bindingx](https://github.com/alibaba/bindingx) ⚠️ Archived [![GitHub stars](https://img.shields.io/github/stars/alibaba/bindingx.svg)]() 基于 weex / React Native 的富交互解决方案。
...
* [weex-amap](https://github.com/weex-plugins/weex-amap) ⚠️ Archived [![GitHub stars](https://img.shields.io/github/stars/weex-plugins/weex-amap.svg)]() 高德地图weex插件

* [WeexPlus](https://github.com/goldze/WeexPlus) ⭐ 76 | 🐛 6 | 🌐 JavaScript | 📅 2022-12-08  [![GitHub stars](https://img.shields.io/github/stars/goldze/WeexPlus.svg)]() 提供weex调用android native方法的一套扩展通信交互库，包含页面导航、数据存储、图片选择、二维码识别、权限等。

* [weex-flymeui](https://github.com/FlymeApps/weex-flymeui) ⚠️ Archived [![GitHub stars](https://img.shields.io/github/stars/FlymeApps/weex-flymeui.svg)]() A Flyme Style UI library based on Weex for Creator.

* [weex-vue-router](https://github.com/dongnaebi/weex-vue-router) ⚠️ Archived [![GitHub stars](https://img.shields.io/github/stars/dongnaebi/weex-vue-router.svg)]() router for weex as you can use some feature of vue-router
